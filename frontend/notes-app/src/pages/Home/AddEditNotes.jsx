...
const editNote = async () => {
    ...
    <div className="relative">
        ...
        <button 
        className="w-10 h-10 rounded-full flex item-center justify-center absolute -top-1 -right-4"
        onClick={onClose}
        >
            <MdClose className="text-xl text-slate-400 cursor-pointer hover:text-slate-700" />
        </button>
